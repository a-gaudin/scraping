...
// function addPropertyToObj(arr, newPropertyName, newPropertyValue) {
//   return arr.forEach((el) => el[newPropertyName] = newPropertyValue);
// }
...
//       addPropertyToObj(newVariations, 'timestamp', timestamp);
